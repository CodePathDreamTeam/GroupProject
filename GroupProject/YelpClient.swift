...
//  Yelp
//
//  Created by Nana on 9/19/14.
//  Copyright (c) 2014 Nana. All rights reserved.
//
...
class YelpClient: BDBOAuth1SessionManager {
    ...
    override init(baseURL url: URL?, sessionConfiguration configuration: URLSessionConfiguration?) {
        super.init(baseURL: URL(string: "https://api.yelp.com/v2/"), sessionConfiguration: nil)
    }
    ...
    func searchWithTerm(_ term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, radius: Float?, completion: @escaping ([Business]?, Error?) -> Void) -> URLSessionDataTask? {
